...
import { ACTIVE_LINE_IDS, RECTIFIED_SIZE, RESERVED_LINE_IDS, type Landmark3, type LineMask, type Point2 } from "../lib/scan/types";
...
/** A hand with every finger curled toward the camera — the pose that hides the lines. */
function curledHand(): { image: Landmark3[]; world: Landmark3[] } {
  ...
  for (const finger of [
    ...
    // Curl out of the palm plane: tip comes back toward the knuckle but sits far along +z.
