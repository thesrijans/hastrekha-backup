...
/*
 * The signature + guard moved to lib/scan/pose-signature.ts (production) so the superRes frame
 * ring can apply the SAME same-pose rule; re-exported here so every harness caller is unchanged.
 */
export {
  POSE_DUP_RADIUS,
